...
def main():
    ...
    for article in all_articles:
        ...
        # パンくずリストを作成
        breadcrumbs = [
            {"name": article['category'], "path": article['category_path']},
            {"name": article['title'], "path": "#"} # 現在のページはリンク不要
        ]
