(function () {
  ...
  async function showPeople() {
    ...
    dialog.innerHTML=`<div class="dialog-loading"><div class="spinner"></div><p>共有メンバーとグループを読み込んでいます…</p></div>`;if(!dialog.open)dialog.showModal();document.documentElement.classList.add("archive-modal-open");
    try {
